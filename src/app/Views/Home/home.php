...
<!--
    <form id="order" name="order"  method="post">
        <img id="addBtn" src="public/images/addSign.png" style="width: 2%; height: 2%" alt="removeSign">
        <img id="removeBtn" src="public/images/removeSign.png" style="width: 2.25%; height: 2.25%" alt="removeSign">
        <input id="morph1" type="text" name="morph1">
        <input id="morph2" type="text" name="morph2">
        <input id="submit" type="submit" name="submit">
    </form>
    <form id="sex" name="sex"  method="post">
        <img id="maleGender" class="gender" src="public/images/maleGender.png" alt="maleGender">
...
?>
    ...
    <div class="padding">
        ...
        <div class="textAlignCenter">
            <img src="../../../../public/images/snake_dummy_image.jpeg" alt="snake image">
        </div>
        <h2>About Us</h2>
