...
<head>
    <meta charset="UTF-8">
    <title>Home</title>
    <link rel="stylesheet" type="text/css" href="Views/Styles/accordion.css">
    <link rel="stylesheet" type="text/css" href="Views/Styles/shared.css">
    <link rel="stylesheet" type="text/css" href="Views/Styles/navbar.css">
    <link rel="stylesheet" type="text/css" href="Views/Styles/home.css">
    <script src="Views/Shared/Scripts/accordion.js" defer></script>
...
?>
    ...
    <div class="container padding">
        ...
        <div class="accordion">
            ...
            <div class="box">
                <div class="question">
                    <h5>What is included in a shed parcel?</h5>
                    <span class="icon"></span>
                </div>
                <div class="content">
                    <div class="content-text">
            ...
            <div class="box">
                <div class="question">
                    <h5>How do I prove I have a CITES permit?</h5>
                    <span class="icon"></span>
                </div>
                <div class="content">
                    <div class="content-text">
            ...
            <div class="box">
                <div class="question">
                    <h5>Where can I find news about this website?</h5>
                    <span class="icon"></span>
                </div>
                <div class="content">
                    <div class="content-text">
