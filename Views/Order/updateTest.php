...
<div class="form-container">
    <form id="order" name="order"
          action="index.php?controller=order&action=submitUpdateTest&id=<?php echo $_GET["id"]; ?>" method="post">
        <label for="customerSnakeId">Snake ID</label><br>
        <input id="customerSnakeId" type="text" name="customerSnakeId"
               value="<?php echo $data["tests"]["customerSnakeId"]; ?>" readonly><br>
        <img id="maleGender" class="gender<?php echo(($sexGender === "maleGender") ? " selected" : ""); ?>"
             src="Views/Images/maleGender.png" alt="maleGender">
        <img id="femaleGender" class="gender<?php echo(($sexGender === "femaleGender") ? " selected" : ""); ?>"
             src="Views/Images/femaleGender.png" alt="femaleGender">
        <img id="unknownGender" class="gender<?php echo(($sexGender === "unknownGender") ? " selected" : ""); ?>"
             src="Views/Images/unknownGender.png" alt="unknownGender">

        <input type="hidden" id="sex" name="sex" value='<?php echo "$sex" ?>'><br>
        <label for="knownMorphs" id="knownMorphLabel">Known morphs</label><br>
        <img id="addBtnKnownMorph" class="add-remove" src="Views/Images/addSign.png" style="width: 2%; height: 2%"
             alt="addSign">
        <img id="removeBtnKnownMorph" class="add-remove" src="Views/Images/removeSign.png"
             style="width: 2.25%; height: 2.25%" alt="removeSign"><br>
        <?php
        ...
        <img id="addBtnTestMorph" class="add-remove" src="Views/Images/addSign.png" style="width: 2%; height: 2%"
             alt="addSign">
        <img id="removeBtnTestMorph" class="add-remove" src="Views/Images/removeSign.png"
             style="width: 2.25%; height: 2.25%" alt="removeSign"><br>
        <?php
        ...
        <input id="snakeOrigin" type="text" name="snakeOrigin" value="<?php echo $data['tests']['origin'] ?>"
               readonly><br>
